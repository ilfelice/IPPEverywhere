...
static const char *kJDScaleToFit            = "JJJJ_scale_to_fit";
...
JobData::operator=(const JobData &jobData)
{
	...
	fScaleToFit            = jobData.fScaleToFit;
	...
	SettingType settingType)
{
	...
	fScaleToFit = message->GetBool(kJDScaleToFit, false);
...
JobData::Save(BMessage* message)
{
	...
	message->RemoveName(kJDScaleToFit);
	message->AddBool(kJDScaleToFit, fScaleToFit);
