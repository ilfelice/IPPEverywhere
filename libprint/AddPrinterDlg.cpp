...
#define B_TRANSLATION_CONTEXT "AddPrinterDlg"
...
AddPrinterView::AttachedToWindow()
{
	...
	protocolClassBox->SetLabel(B_TRANSLATE("Protocol classes:"));
...
AddPrinterDlg::AddPrinterDlg(PrinterData* printerData,
	...
	DialogWindow(BRect(100, 100, 120, 120),
		B_TRANSLATE("Add printer"), B_TITLED_WINDOW_LOOK, B_MODAL_APP_WINDOW_FEEL,
