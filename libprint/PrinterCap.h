...
public:
	...
	enum CapID {
		...
		kScaleToFit,	// offer "Scale to fit page" in the page setup
						// (implemented by GraphicsDriver)
		kCollateCommand,// the printer collates copies itself (only
						// meaningful together with kCopyCommand)
