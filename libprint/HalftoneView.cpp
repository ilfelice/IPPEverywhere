...
#define B_TRANSLATION_CONTEXT "HalftoneView"
	...
	BView(frame, name, resizeMask, flags)
{
	...
	const char* kRedLabel   = B_TRANSLATE("Red: ");
	const char* kGreenLabel = B_TRANSLATE("Green: ");
	const char* kBlueLabel  = B_TRANSLATE("Blue: ");
	const char* kGrayLabel  = B_TRANSLATE("Black: ");
